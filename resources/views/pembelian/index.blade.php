...
@section('title', config('app.name').' | Daftar Pembelian')
...
<script>
    $(function() {
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            var deleteUrl = "{{ url('pembelian/delete') }}" + "/" + dataId;
            var csrf = "{{ csrf_token() }}";
...
<div class="modal inmodal" id="modalUpload" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-content animated bounceInRight">
            ...
            <form action="{{ url('pembelian/upload') }}" method="post" role="form" enctype="multipart/form-data">
                @csrf
